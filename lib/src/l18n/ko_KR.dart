...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      'autoRetryCount': '네트워크 실패 시 자동 재시도 횟수',
      'autoRetryCountHint': '0으로 설정하면 재시도 비활성화, -1은 무한 재시도, 최대값 10',
      'retryDelay': '재시도 지연 시간',
      'retryDelayHint': '0으로 설정하면 지연 없음, 최대값 3000ms',
      'retrying': '재시도 중',
      ...
      /// search page
      'search': '검색',
      'searchWithArtist': '검색作者',
      'searchWithGroup': '검색团队',
      'searchFailed': '검색 실패',
