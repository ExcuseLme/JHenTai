...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'hideScroll2BottomButton': '隱藏快速回底按鈕',
      'scrollCurve': '滾動動畫曲線',
      'scrollCurve_linear': '勻速。平滑穩定的滾動。',
      'scrollCurve_ease': '慢-快-慢。自然的通用過渡。',
      'scrollCurve_easeIn': '慢-快。物體加速離開。',
      ...
      'scrollCurve_fastOutSlowIn': 'Material Design 推薦。平滑過渡。',
      ...
      'scrollSensitivity': '滑動靈敏度',
      'scrollSensitivityHint': '放大滑動距離，1.0為預設值，長按重置為預設值',
      'resetSuccess': '重置成功',
      ...
      'autoRetryCount': '網路失敗自動重試次數',
      'autoRetryCountHint': '設為0停用重試，-1為無限重試，最大值10',
      'retryDelay': '重試間隔',
      'retryDelayHint': '設為0表示無間隔，最大值3000毫秒',
      'retrying': '重試中',
