...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      'hideScroll2BottomButton': '隐藏快速回底按钮',
      'scrollCurve': '滚动动画曲线',
      'scrollCurve_linear': '匀速。平滑稳定的滚动。',
      'scrollCurve_ease': '慢-快-慢。自然的通用过渡。',
      'scrollCurve_easeIn': '慢-快。物体加速离开。',
      ...
      'scrollCurve_fastOutSlowIn': 'Material Design 推荐。平滑过渡。',
      ...
      'autoRetryCount': '网络失败自动重试次数',
      'autoRetryCountHint': '设为0禁用重试，-1为无限重试，最大值10',
      'retryDelay': '重试间隔',
      'retryDelayHint': '设为0表示无间隔，最大值3000毫秒',
      'retrying': '重试中',
