...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      'scrollCurve_linear': 'Постоянная скорость. Плавная и ровная прокрутка.',
      'scrollCurve_ease': 'Медленно-быстро-медленно. Естественный переход.',
      'scrollCurve_easeIn': 'Медленно-быстро. Ускоряющееся движение.',
      ...
      'autoLanguageFilterTargetHint': 'Значение автоматического фильтра языка',
