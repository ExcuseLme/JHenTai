...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      'scrollCurve': 'Кривая анимации прокрутки',
      'scrollCurve_linear': 'Постоянная скорость. Плавная и стабильная прокрутка.',
      'scrollCurve_ease': 'Медленно-быстро-медленно. Естественный переход.',
      'scrollCurve_easeIn': 'Медленно-быстро. Объект ускоряется.',
      'scrollCurve_easeOut': 'Быстро-медленно. Объект замедляется.',
      'scrollCurve_easeInOut': 'Медленно-быстро-медленно (симметрично). Сбалансированный переход.',
      'scrollCurve_decelerate': 'Быстро-медленно. Эффект инерции.',
      'scrollCurve_bounceOut': 'Пружинящий конец. Эластичная остановка.',
      ...
      'scrollSensitivityHint': 'Увеличение расстояния прокрутки, 1.0 по умолчанию, долгое нажатие для сброса',
      ...
      'autoRetryCountHint': '0 — отключить повторы, -1 — бесконечные повторы, максимум 10',
      'retryDelay': 'Задержка между повторными попытками',
      'retryDelayHint': '0 — без задержки, максимум 3000мс',
      ...
      'longPressDuration': 'Длительность долгого нажатия',
      'longPressDurationHint': 'Время удержания для срабатывания долгого нажатия, долгое нажатие для сброса',
